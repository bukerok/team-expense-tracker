 ...
 * http://polymer.github.io/PATENTS.txt
 */
class g{constructor(t,e,s){this.__parts=[],this.template=t,this.processor=e,this.options=s}update(t){let e=0;for(const s of this.__parts)void 0!==s&&s.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=i?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],s=this.template.parts,n=document.createTreeWalker(t,133,null,!1);let r,o=0,a=0,l=n.nextNode();for(;o<s.length;)if(r=s[o],h(r)){for(;a<r.index;)a++,"TEMPLATE"===l.nodeName&&(e.push(l),n.currentNode=l.content),null===(l=n.nextNode())&&(n.currentNode=e.pop(),l=n.nextNode());if("node"===r.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(l.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(l,r.name,r.strings,this.options));o++}else this.__parts.push(void 0),o++;return i&&(document.adoptNode(t),customElements.upgrade(t)),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const _=` ${a} `;class f{constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",s=!1;for(let i=0;i<t;i++){const t=this.strings[i],n=t.lastIndexOf("\x3c!--");s=(n>-1||s)&&-1===t.indexOf("--\x3e",n+1);const r=m.exec(t);e+=null===r?t+(s?_:l):t.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+a}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const T=new class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new C(t,e.slice(1),s).parts}return"@"===n?[new E(t,e.slice(1),i.eventContext)]:"?"===n?[new w(t,e.slice(1),s)]:new x(t,e,s).parts}handleTextExpression(t){return new b(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function V(t){let e=$.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},$.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const i=t.strings.join(a);return s=e.keyString.get(i),void 0===s&&(s=new d(t,t.getTemplateElement()),e.keyString.set(i,s)),e.stringsArray.set(t.strings,s),s}const $=new Map,k=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const O=(t,...e)=>new f(t,e,"html",T)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function R(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,133,null,!1);let r=M(i),o=i[r],a=-1,l=0;const c=[];let d=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==o&&o.index===a;)o.index=null!==d?-1:o.index-l,r=M(i,r),o=i[r]}c.forEach(t=>t.parentNode.removeChild(t))}const U=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,133,null,!1);for(;s.nextNode();)e++;return e},M=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(h(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const tt=new WeakMap,et=(st=t=>e=>{if(!(e instanceof S)||e instanceof P||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:s}=e,{element:i}=s;tt.has(e)||(i.className=s.strings.join(" "));const{classList:n}=i,r=tt.get(e);for(const e in r)e in t||n.remove(e);for(const e in t){const s=t[e];r&&s===r[e]||n[s?"add":"remove"](e)}tt.set(e,t)},(...t)=>{const s=st(...t);return e.set(s,!0),s});var st;customElements.define("expense-logs",class extends Z{static get properties(){return{logs:{type:Array}}}static get styles(){return X`
      p {
        margin: 0;
      }
    ...
    `}render(){return 0===this.logs.length?O`
        No logs.
      `:O`
      <ul class="logs">
        ${this.logs.map(({_metadata:t,participants:e})=>O`
            <li class="log-item">
    ...
    `}});customElements.define("expense-table",class extends Z{static get properties(){return{logs:{type:Array}}}static get styles(){return X`
      .wrapper {
        display: grid;
    ...
    `}render(){const t=this.getAccumulatedTable(this.logs),e=this.getAccumulation(t);return O`
      <div class="wrapper">
        ...
        ${Object.keys(t).map(e=>{const s=t[e];return O`
                <div class="card">
                  <span>${e}</span>
                  <span
    ...
    `}getAccumulatedTable(t){return t.reduce((t,{participants:e})=>(e.forEach(([e,s])=>{t[e]=(t[e]||0)+s}),t),{})}getAccumulation(t){let e=0;return Object.keys(t).forEach(s=>{e+=t[s]}),-e}});customElements.define("expense-tracker",class extends Z{constructor(...e){super(...e),t(this,"logs",void 0)}static get properties(){return{users:{type:Array}}}static get styles(){return X`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}connectedCallback(){super.connectedCallback(),this.logs=JSON.parse(localStorage.getItem("expense-logs"))||[]}render(){return O`
      <div class="wrapper">
    ...
    `}logExpense(t){this.logs=[...this.logs,{participants:t.detail.participants,_metadata:{date:Date.now()}}],localStorage.setItem("expense-logs",JSON.stringify(this.logs)),this.requestUpdate()}});
